...
天井なしにすると、ボットの波がそのまま請求額になります。**弾力性より封じ込めを選ぶ**という、技術ではなくリスクの判断です。

ただ、上限を2台にした理由はコストだけではありません。**そもそも、台数を増やしても速くならないからです。**
...
だから2台目は、**速くするためではなく、落ちないために**あります（デプロイ中と、1台が死んだとき）。
